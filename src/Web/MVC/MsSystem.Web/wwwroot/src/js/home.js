...
$(function () {
    ...
    function refreshPage() {
        var pretabaid = $('a.active.J_menuTab i').parent().prev().attr('data-id');
        if (pretabaid) {
            var preiframe = $('.J_mainContent .J_iframe[data-id="' + pretabaid + '"]')[0];
...
$(function () {
    //全屏
    $("#ms_fullscreen_btn").on("click", function () {
    ...
    function exitFullscreen() {
        ...
        if (f.exitFullscreen) {
            ...
            if (f.mozCancelFullScreen) {
                f.mozCancelFullScreen();
            } else {
                if (f.webkitCancelFullScreen) {
